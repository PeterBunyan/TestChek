...
# Useage
Download zip file and, after unzipping, open the solution file in Microsoft Visual Studio. Build ("Ctrl"+"Shift"+"B") and run the application.
...
Additionaly, you may create an account through the "Register" link on the navigation bar. Once created, you may access the "My Account" section and view a set of laboratory test results that represents a recent visit to a healthcare provider.
